...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tinygltf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13010&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tinygltf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tinygltf` can be installed with:

```
conda install tinygltf
```

It is possible to list all of the versions of `tinygltf` available on your platform with:
